...
func StartJSONRPC(
	...
	apis := rpc.GetRPCAPIs(srvCtx, clientCtx, stream, allowUnprotectedTxs, indexer, rpcAPIArr, mempool, config.JSONRPC.FeePayerPrivKey, config.JSONRPC.CustomFeeResponse)
